...
const emits = defineEmits(['viewDetails', 'updateAction', 'deletedAction']);
</script>
                ...
                <tr v-for="(row, rowIndex) in TableContent" :key="rowIndex">
                    ...
                    <td v-if="TableActions">
                        <div class="actions">
                            ...
                            <div class="edit" @click="$emit('updateAction', row.id)">
                            ...
                            <div class="deleted" @click="$emit('deletedAction', row.id)">
                                <svg width="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
