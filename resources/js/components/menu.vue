   ...
   <ModalComponentExit class="exitModal" v-if="exitModal" Titlevalue="Você realmente gostaria de sair do sistema ?">
    ...
    <nav class="sidebar">
        ...
        <div class="menu-bar">
            <div class="menu">
                <ul class="menu-links">
                    <a href="/dashboard" title="Ir para o inicio">
                    <li class="nav-link">
                ...
                <a href="/Filters">
                    <li class="nav-link" title="Ir para os Gráficos de desempenho">
                            ...
                            <span class="text nav-text">Gráficos de desempenho</span>
                    </li>
                </a>
                <a href="/Management">
                    <li class="nav-link" title="Ir para o Gerenciamento">
                            ...
                            <span class="text nav-text">Gerenciamento</span>
                    </li>
                </a>
                </ul>
            </div>
        ...
        <div class="menu-section2">
            <ul class="menu-links">
                <a href="/ContactUs" title="Ir para os contatos">
                <li class="nav-link">
                    <svg width="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <a style="cursor: pointer;" @click="openExitModal()" title="Sair do sistema">
                <li class="nav-link">
                        <svg width="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
