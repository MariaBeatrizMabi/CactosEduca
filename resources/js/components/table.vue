...
const exportData = () => jsonToXlsx({
    name: 'Escolas',
    data: formData.value.map((data) => ({
        'Nome': data.name,
        'Múnicipio': data.city_name,
        'Localidade': data.location_id,
        'Código de acesso': data.acess_cod
    })),
});
</script>
...
<div class="tableContent">
   <div class="showModalContent">
        <button class="showModalInfo" @click="exportData">
