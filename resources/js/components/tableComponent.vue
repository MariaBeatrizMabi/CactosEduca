                            ...
                            <td v-if="TableActions">
                                <div class="actions">
                                    <div
                                        ...
                                        <div class="tooltip d-none" :id="`${rowIndex}-show-class`">
                                    ...
                                    >
                                        ...
                                        <div class="tooltip d-none" :id="`${rowIndex}-create-exam`">
                                            Cadastrar sondagem
                                        </div>
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div class="tooltip d-none" :id="`${rowIndex}-update-class`">
                                            Atualizar turma
                                        </div>
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div class="tooltip-delete d-none" :id="`${rowIndex}-delete-class`">
                                            Deletar turma
                                        </div>
                                    </div>
                                </div>
