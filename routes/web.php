...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/schoolDetails/{cityId}/school/{schoolNames}', [SchoolDetails::class, 'indexMultipleSchools'])->where(['cityId' => '[0-9]+', 'schoolNames' => '[\pL\s,]+'])->name('SchoolDetailsByCityAndSchools');

    Route::get('/schoolDetails/all', [SchoolDetails::class, 'indexAll'])->name('SchoolDetailsAll');
    ...
    Route::get('/schoolDetails/{city}/{schoolName}/{schoolId}', 'App\Http\Controllers\SchoolDetails@indexSchoolDetailsByCityAndSchoolView')->name('SchoolDetailsByCityAndSchool');

    Route::get('/schoolDetails/json/{city}/{schoolName}/{schoolId}', [SchoolDetails::class, 'getSchoolDetails'])->name('school_details.SchoolDetailsJson');
    ...
    Route::get('/ManagementSchool/{city_id}/all', 'App\Http\Controllers\SchoolDetails@indexAllByCity')->where(['city_id' => '[0-9]+'])->name('SchoolDetailsAllByCity');
    ...
    Route::get('/teachersBySchool/{schoolId}', [TeacherController::class, 'findteachersBySchool']);
    ...
    Route::get('/classesByschool/{schoolId}', [ManagementClassController::class, 'getAllClassesFromSchool']);
